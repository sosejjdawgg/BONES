...
- **Delivery Driver** — an isometric driving minigame: deliver parcels to the right houses along a street for cash, avoiding decoy (non-delivery) houses. The van accelerates the whole way down the road — there's a speedometer bottom-right, and the speed lines, rumble and engine note all build with it. Delivering is one action: **hold**, and don't let go. The van pulls over and the driver walks the parcel up to the door while a ticking countdown runs — let go too early, while the box is still in his hands, and he trips, fumbling it in front of the house. Past the last house the controls become the brake: a **SLOW DOWN** sign, then a hatched bay you have to stop the van inside. Brake early and you stop short, brake late and you go into the wall. Pay is lopsided on purpose — a safe delivery is +$4, a parcel never attempted −$7, and a fumbled one −$42 — and the run is rated against a 45-second par.
